...
def write_evidence_manifest(
    ...
    *,
    ...
    readback_report: Path | None = None,
    rollback_report: Path | None = None,
    incident_artifact: Path | None = None,
    ...
    payload = {
        ...
        "artifacts": {
            ...
            "readback_report": None if readback_report is None else str(readback_report),
            "rollback_report": None if rollback_report is None else str(rollback_report),
            "incident_artifact": None if incident_artifact is None else str(incident_artifact),
